            ...
            <div className="col-sm-12 col-md-3">
              <nav className="navbar navbar-light bg-light">
                {/* <a className="navbar-brand" href> */}
                  <div className="logo">
                    <Link to="/"><img src="https://www.memuevo.cl/wp-content/themes/newmemuevo/img/logo.png" width="90" height="70" className="d-inline-block align-top" alt="logo de la fundación" /></Link>
                  </div>
                {/* </a> */}
